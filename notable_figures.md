# Loudest & Most Active Voices in the NXR / Reformed "Based" Space

Compiled 2026-06-24. The most prominent, media-active voices in the New Christian Right / Reformed-postmill / Christian-nationalist / abolitionist online ecosystem. `[#id]` = that figure's church is in the directory. Honest note: the genuinely *loud* tier is ~55 — I prioritized real prominence over padding to a literal 100 (per instruction).
...
- **Glenn Sunshine** — historian; Theology Pugcast; FLF speaker.
...
- **George Grant** — Parish Presbyterian, Franklin TN `[#279]`. King's Meadow Study Center; New College Franklin.

## Other prominent voices
- **Kendall Lankford** — The Shepherd's Church, Chelmsford MA `[#24]`. The Prodcast; "The Future is Christian Nationalism."
- **Joseph Spurgeon** — Sovereign King Church, Jeffersonville IN `[#66]`. Postmill abolitionist.
- **Dale Partridge** — King's Way Reformed, Prescott AZ `[#20]`. Relearn.org; Reformation Red Pill.
...
## Polemics / discernment media
- **Jordan "J.D." Hall** — founder of **Pulpit & Pen** (later *Protestia*) and *Montana Daily Gazette*; former pastor, Fellowship Baptist Church, Sidney MT. For a decade the most-read polemics voice on the Reformed right, and a significant early driver of the anti-woke turn inside the SBC — the "discernment blog" format he built shaped how much of this movement argues online. **No longer in ministry or media**: Fellowship Baptist declared him "disqualified from pastoral ministry" in June 2022 over serious sin, he was removed from Protestia, and he was later found guilty of embezzling from that church. No settled congregation; listed for his historical influence on the movement, not as a current voice.
