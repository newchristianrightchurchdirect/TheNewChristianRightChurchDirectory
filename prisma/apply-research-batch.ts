...
async function main(){
  ...
  for (const r of rows){
    ...
    for (const k of ['denomination','leadership','theologicalNotes','zionistStance','abolitionStance','christianNationalism','eschatology','theonomy','federalVision','socialJusticeStance','website','phone','email','description','researchNote','recordFlag','stanceBasis','sourceUrls','address','zip'])
